...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)/profilepage` | `/_sitemap` | `/accountcreation` | `/configuration/interests` | `/configuration/major` | `/configuration/university` | `/configuration/yearofstudy` | `/login` | `/profilepage`;
