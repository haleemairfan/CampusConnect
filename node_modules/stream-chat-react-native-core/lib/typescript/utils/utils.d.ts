 ...
 */
export declare const stringifyMessage: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>({ deleted_at, latest_reactions, reaction_groups, readBy, reply_count, status, text, type, updated_at, }: MessageResponse<StreamChatGenerics> | MessageType<StreamChatGenerics>) => string;
/**
